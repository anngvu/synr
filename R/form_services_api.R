  ...
  public = list(
    ...
    getRepoV1FormGroupIdWithHttpInfo = function(id, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelFormFormGroup", loadNamespace("synr")),
          error = function(e) {
    ...
    postRepoV1FormDataWithHttpInfo = function(group_id, org_sagebionetworks_repo_model_form_form_change_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelFormFormData", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1FormDataListWithHttpInfo = function(org_sagebionetworks_repo_model_form_list_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelFormListResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
