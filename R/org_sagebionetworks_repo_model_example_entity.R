...
OrgSagebionetworksRepoModelExampleEntity <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`concreteType`, `name` = NULL, `description` = NULL, `id` = NULL, `etag` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `parentId` = NULL, `singleString` = NULL, `stringList` = NULL, `singleDate` = NULL, `dateList` = NULL, `singleDouble` = NULL, `doubleList` = NULL, `singleInteger` = NULL, `integerList` = NULL, `concept` = NULL, `someEnum` = NULL, `references` = NULL, `environmentDescriptors` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.ExampleEntity"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.ExampleEntity\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.ExampleEntity"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.ExampleEntity\".", sep = ""))
        }
      ...
      if (!is.null(this_object$`stringList`)) {
        self$`stringList` <- ApiClient$new()$deserializeObj(this_object$`stringList`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`singleDate`)) {
        self$`singleDate` <- this_object$`singleDate`
      }
      if (!is.null(this_object$`dateList`)) {
        self$`dateList` <- ApiClient$new()$deserializeObj(this_object$`dateList`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`singleDouble`)) {
        self$`singleDouble` <- this_object$`singleDouble`
      }
      if (!is.null(this_object$`doubleList`)) {
        self$`doubleList` <- ApiClient$new()$deserializeObj(this_object$`doubleList`, "array[numeric]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`singleInteger`)) {
        self$`singleInteger` <- this_object$`singleInteger`
      }
      if (!is.null(this_object$`integerList`)) {
        self$`integerList` <- ApiClient$new()$deserializeObj(this_object$`integerList`, "array[integer]", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`references`)) {
        self$`references` <- ApiClient$new()$deserializeObj(this_object$`references`, "array[OrgSagebionetworksRepoModelReference]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`environmentDescriptors`)) {
        self$`environmentDescriptors` <- ApiClient$new()$deserializeObj(this_object$`environmentDescriptors`, "array[OrgSagebionetworksRepoModelEnvironmentDescriptor]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelExampleEntity: the required field `concreteType` is missing."))
      }
    },
