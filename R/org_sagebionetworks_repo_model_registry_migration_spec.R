  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`migrationMetadata`)) {
        self$`migrationMetadata` <- ApiClient$new()$deserializeObj(this_object$`migrationMetadata`, "array[OrgSagebionetworksRepoModelRegistryEntityTypeMigrationSpec]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
