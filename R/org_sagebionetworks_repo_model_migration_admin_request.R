...
OrgSagebionetworksRepoModelMigrationAdminRequest <- R6::R6Class(
  ...
  public = list(
    ...
    one_of = list("OrgSagebionetworksRepoModelMigrationAsyncMigrationRangeChecksumRequest", "OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeChecksumRequest", "OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountRequest", "OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountsRequest", "OrgSagebionetworksRepoModelMigrationBackupTypeRangeRequest", "OrgSagebionetworksRepoModelMigrationBatchChecksumRequest", "OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeRequest", "OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest", "OrgSagebionetworksRepoModelMigrationRestoreTypeRequest"),
    #' Initialize a new OrgSagebionetworksRepoModelMigrationAdminRequest.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelMigrationAdminRequest.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "OrgSagebionetworksRepoModelMigrationAsyncMigrationRangeChecksumRequest", "OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeChecksumRequest", "OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountRequest", "OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountsRequest", "OrgSagebionetworksRepoModelMigrationBackupTypeRangeRequest", "OrgSagebionetworksRepoModelMigrationBatchChecksumRequest", "OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeRequest", "OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest", "OrgSagebionetworksRepoModelMigrationRestoreTypeRequest"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
      ...
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest") {
        self$actual_instance <- instance
        self$actual_type <- "OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest"
        ...
        stop(paste("Failed to initialize OrgSagebionetworksRepoModelMigrationAdminRequest with oneOf schemas OrgSagebionetworksRepoModelMigrationAsyncMigrationRangeChecksumRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeChecksumRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountsRequest, OrgSagebionetworksRepoModelMigrationBackupTypeRangeRequest, OrgSagebionetworksRepoModelMigrationBatchChecksumRequest, OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeRequest, OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest, OrgSagebionetworksRepoModelMigrationRestoreTypeRequest. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      `OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest_result` <- tryCatch({
          `OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest`$public_methods$validateJSON(input)
          `OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest_instance` <- `OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest`$new()
          instance <- `OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest_instance`$fromJSON(input)
          instance_type <- "OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest"
          matched_schemas <- append(matched_schemas, "OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest_result`["error"])) {
        error_messages <- append(error_messages, `OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest_result`["message"])
      }
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into OrgSagebionetworksRepoModelMigrationAdminRequest with oneOf schemas OrgSagebionetworksRepoModelMigrationAsyncMigrationRangeChecksumRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeChecksumRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountsRequest, OrgSagebionetworksRepoModelMigrationBackupTypeRangeRequest, OrgSagebionetworksRepoModelMigrationBatchChecksumRequest, OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeRequest, OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest, OrgSagebionetworksRepoModelMigrationRestoreTypeRequest. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into OrgSagebionetworksRepoModelMigrationAdminRequest with oneOf schemas OrgSagebionetworksRepoModelMigrationAsyncMigrationRangeChecksumRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeChecksumRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountRequest, OrgSagebionetworksRepoModelMigrationAsyncMigrationTypeCountsRequest, OrgSagebionetworksRepoModelMigrationBackupTypeRangeRequest, OrgSagebionetworksRepoModelMigrationBatchChecksumRequest, OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeRequest, OrgSagebionetworksRepoModelMigrationDatasetBackfillRequest, OrgSagebionetworksRepoModelMigrationRestoreTypeRequest. Details: >>",
