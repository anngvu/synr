...
#' @field results  list(\link{OrgSagebionetworksEvaluationModelSubmissionStatus}) [optional]
...
PaginatedResultsOfSubmissionStatus <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return PaginatedResultsOfSubmissionStatus in JSON format
    #' @export
    toJSON = function() {
    ...
    #' @return the instance of PaginatedResultsOfSubmissionStatus
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[OrgSagebionetworksEvaluationModelSubmissionStatus]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to PaginatedResultsOfSubmissionStatus
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PaginatedResultsOfSubmissionStatus
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedResultsOfSubmissionStatus$unlock()
#
## Below is an example to define the print function
# PaginatedResultsOfSubmissionStatus$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedResultsOfSubmissionStatus$lock()
