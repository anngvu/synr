...
#' @field derivedAnnotations  \link{OrgSagebionetworksRepoModelAnnotationV2Annotations} [optional]
...
OrgSagebionetworksRepoModelAuditNodeRecord <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param derivedAnnotations derivedAnnotations
    #' @param id id
    #' @param name name
    ...
    initialize = function(`isPublic` = NULL, `isRestricted` = NULL, `isControlled` = NULL, `benefactorId` = NULL, `projectId` = NULL, `effectiveArs` = NULL, `annotations` = NULL, `derivedAnnotations` = NULL, `id` = NULL, `name` = NULL, `description` = NULL, `parentId` = NULL, `createdByPrincipalId` = NULL, `createdOn` = NULL, `modifiedByPrincipalId` = NULL, `modifiedOn` = NULL, `nodeType` = NULL, `eTag` = NULL, `versionNumber` = NULL, `versionComment` = NULL, `versionLabel` = NULL, `isLatestVersion` = NULL, `activityId` = NULL, `fileHandleId` = NULL, `columnModelIds` = NULL, `scopeIds` = NULL, `items` = NULL, `reference` = NULL, `alias` = NULL, `isSearchEnabled` = NULL, `definingSQL` = NULL, ...) {
      ...
      if (!is.null(`derivedAnnotations`)) {
        stopifnot(R6::is.R6(`derivedAnnotations`))
        self$`derivedAnnotations` <- `derivedAnnotations`
      }
      if (!is.null(`id`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`annotations`)) {
        OrgSagebionetworksRepoModelAuditNodeRecordObject[["annotations"]] <-
          self$`annotations`$toJSON()
      }
      if (!is.null(self$`derivedAnnotations`)) {
        OrgSagebionetworksRepoModelAuditNodeRecordObject[["derivedAnnotations"]] <-
          self$`derivedAnnotations`$toJSON()
      }
      if (!is.null(self$`id`)) {
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`effectiveArs`)) {
        self$`effectiveArs` <- ApiClient$new()$deserializeObj(this_object$`effectiveArs`, "array[integer]", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`derivedAnnotations`)) {
        `derivedannotations_object` <- OrgSagebionetworksRepoModelAnnotationV2Annotations$new()
        `derivedannotations_object`$fromJSON(jsonlite::toJSON(this_object$`derivedAnnotations`, auto_unbox = TRUE, digits = NA))
        self$`derivedAnnotations` <- `derivedannotations_object`
      }
    ...
    toJSONString = function() {
      jsoncontent <- c(
        ...
        if (!is.null(self$`derivedAnnotations`)) {
          ...
          %s
          ',
          jsonlite::toJSON(self$`derivedAnnotations`$toJSON(), auto_unbox = TRUE, digits = NA)
          )
        },
        if (!is.null(self$`id`)) {
          sprintf(
...
',
    ...
    fromJSONString = function(input_json) {
      ...
      self$`derivedAnnotations` <- OrgSagebionetworksRepoModelAnnotationV2Annotations$new()$fromJSON(jsonlite::toJSON(this_object$`derivedAnnotations`, auto_unbox = TRUE, digits = NA))
      self$`id` <- this_object$`id`
      self$`name` <- this_object$`name`
      self$`description` <- this_object$`description`
      self$`parentId` <- this_object$`parentId`
