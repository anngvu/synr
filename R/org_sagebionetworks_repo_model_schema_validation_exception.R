  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`causingExceptions`)) {
        self$`causingExceptions` <- ApiClient$new()$deserializeObj(this_object$`causingExceptions`, "array[OrgSagebionetworksRepoModelSchemaValidationException]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
