  ...
  public = list(
    ...
    getRepoV1ProjectsWithHttpInfo = function(team_id = NULL, filter = NULL, sort = NULL, sort_direction = NULL, next_page_token = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelProjectHeaderList", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1UserWithHttpInfo = function(offset = NULL, limit = NULL, sort = NULL, ascending = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "PaginatedResultsOfUserProfile", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1UserBundleWithHttpInfo = function(mask, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelUserBundle", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1UserGroupHeadersWithHttpInfo = function(prefix = NULL, type_filter = NULL, offset = NULL, limit = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelUserGroupHeaderResponsePage", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1UserProfileWithHttpInfo = function(data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelUserProfile", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1UserGroupHeadersAliasesWithHttpInfo = function(org_sagebionetworks_repo_model_principal_alias_list, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelPrincipalUserGroupHeaderResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1UserProfileWithHttpInfo = function(org_sagebionetworks_repo_model_id_list, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "ListWrapperOfUserProfile", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
