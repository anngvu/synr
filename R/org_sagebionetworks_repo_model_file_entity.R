#' Create a new OrgSagebionetworksRepoModelFileEntity
#'
#' @description
#' JSON schema for File POJO
#'
#' @docType class
#' @title OrgSagebionetworksRepoModelFileEntity
#' @description OrgSagebionetworksRepoModelFileEntity Class
...
#' @field fileNameOverride  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
OrgSagebionetworksRepoModelFileEntity <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new OrgSagebionetworksRepoModelFileEntity class.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelFileEntity class.
    #'
    ...
    #' @param fileNameOverride fileNameOverride
    #' @param ... Other optional arguments.
    #' @export
    initialize = function(`concreteType`, `name` = NULL, `description` = NULL, `id` = NULL, `etag` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `parentId` = NULL, `versionNumber` = NULL, `versionLabel` = NULL, `versionComment` = NULL, `isLatestVersion` = NULL, `dataFileHandleId` = NULL, `fileNameOverride` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.FileEntity"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.FileEntity\".", sep = ""))
        }
      ...
      if (!is.null(`fileNameOverride`)) {
        if (!(is.character(`fileNameOverride`) && length(`fileNameOverride`) == 1)) {
          stop(paste("Error! Invalid data for `fileNameOverride`. Must be a string:", `fileNameOverride`))
        }
    ...
    #' To JSON String
    #'
    #' @return OrgSagebionetworksRepoModelFileEntity in JSON format
    #' @export
    toJSON = function() {
      OrgSagebionetworksRepoModelFileEntityObject <- list()
      if (!is.null(self$`name`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`description`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`id`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`etag`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["etag"]] <-
          self$`etag`
      }
      if (!is.null(self$`createdOn`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["createdOn"]] <-
          self$`createdOn`
      }
      if (!is.null(self$`modifiedOn`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["modifiedOn"]] <-
          self$`modifiedOn`
      }
      if (!is.null(self$`createdBy`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`parentId`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["parentId"]] <-
          self$`parentId`
      }
      if (!is.null(self$`concreteType`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["concreteType"]] <-
          self$`concreteType`
      }
      if (!is.null(self$`versionNumber`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["versionNumber"]] <-
          self$`versionNumber`
      }
      if (!is.null(self$`versionLabel`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["versionLabel"]] <-
          self$`versionLabel`
      }
      if (!is.null(self$`versionComment`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["versionComment"]] <-
          self$`versionComment`
      }
      if (!is.null(self$`isLatestVersion`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["isLatestVersion"]] <-
          self$`isLatestVersion`
      }
      if (!is.null(self$`dataFileHandleId`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["dataFileHandleId"]] <-
          self$`dataFileHandleId`
      }
      if (!is.null(self$`fileNameOverride`)) {
        OrgSagebionetworksRepoModelFileEntityObject[["fileNameOverride"]] <-
          self$`fileNameOverride`
      }
      OrgSagebionetworksRepoModelFileEntityObject
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelFileEntity
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelFileEntity
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrgSagebionetworksRepoModelFileEntity
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.FileEntity"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.FileEntity\".", sep = ""))
        }
      ...
      if (!is.null(this_object$`fileNameOverride`)) {
        self$`fileNameOverride` <- this_object$`fileNameOverride`
      }
      self
    },
    #' To JSON string
    ...
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelFileEntity
    #'
    #' @description
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelFileEntity and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelFileEntity: the required field `concreteType` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrgSagebionetworksRepoModelFileEntity
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrgSagebionetworksRepoModelFileEntity$unlock()
#
## Below is an example to define the print function
# OrgSagebionetworksRepoModelFileEntity$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrgSagebionetworksRepoModelFileEntity$lock()
