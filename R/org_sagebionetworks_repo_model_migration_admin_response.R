...
OrgSagebionetworksRepoModelMigrationAdminResponse <- R6::R6Class(
  ...
  public = list(
    ...
    one_of = list("OrgSagebionetworksRepoModelMigrationBackupTypeResponse", "OrgSagebionetworksRepoModelMigrationBatchChecksumResponse", "OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeResponse", "OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse", "OrgSagebionetworksRepoModelMigrationMigrationRangeChecksum", "OrgSagebionetworksRepoModelMigrationMigrationTypeChecksum", "OrgSagebionetworksRepoModelMigrationMigrationTypeCount", "OrgSagebionetworksRepoModelMigrationMigrationTypeCounts", "OrgSagebionetworksRepoModelMigrationRestoreTypeResponse"),
    #' Initialize a new OrgSagebionetworksRepoModelMigrationAdminResponse.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelMigrationAdminResponse.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "OrgSagebionetworksRepoModelMigrationBackupTypeResponse", "OrgSagebionetworksRepoModelMigrationBatchChecksumResponse", "OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeResponse", "OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse", "OrgSagebionetworksRepoModelMigrationMigrationRangeChecksum", "OrgSagebionetworksRepoModelMigrationMigrationTypeChecksum", "OrgSagebionetworksRepoModelMigrationMigrationTypeCount", "OrgSagebionetworksRepoModelMigrationMigrationTypeCounts", "OrgSagebionetworksRepoModelMigrationRestoreTypeResponse"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
      ...
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse") {
        self$actual_instance <- instance
        self$actual_type <- "OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse"
        ...
        stop(paste("Failed to initialize OrgSagebionetworksRepoModelMigrationAdminResponse with oneOf schemas OrgSagebionetworksRepoModelMigrationBackupTypeResponse, OrgSagebionetworksRepoModelMigrationBatchChecksumResponse, OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeResponse, OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse, OrgSagebionetworksRepoModelMigrationMigrationRangeChecksum, OrgSagebionetworksRepoModelMigrationMigrationTypeChecksum, OrgSagebionetworksRepoModelMigrationMigrationTypeCount, OrgSagebionetworksRepoModelMigrationMigrationTypeCounts, OrgSagebionetworksRepoModelMigrationRestoreTypeResponse. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      `OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse_result` <- tryCatch({
          `OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse`$public_methods$validateJSON(input)
          `OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse_instance` <- `OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse`$new()
          instance <- `OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse_instance`$fromJSON(input)
          instance_type <- "OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse"
          matched_schemas <- append(matched_schemas, "OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse_result`["error"])) {
        error_messages <- append(error_messages, `OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse_result`["message"])
      }
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into OrgSagebionetworksRepoModelMigrationAdminResponse with oneOf schemas OrgSagebionetworksRepoModelMigrationBackupTypeResponse, OrgSagebionetworksRepoModelMigrationBatchChecksumResponse, OrgSagebionetworksRepoModelMigrationCalculateOptimalRangeResponse, OrgSagebionetworksRepoModelMigrationDatasetBackfillResponse, OrgSagebionetworksRepoModelMigrationMigrationRangeChecksum, OrgSagebionetworksRepoModelMigrationMigrationTypeChecksum, OrgSagebionetworksRepoModelMigrationMigrationTypeCount, OrgSagebionetworksRepoModelMigrationMigrationTypeCounts, OrgSagebionetworksRepoModelMigrationRestoreTypeResponse. Matched schemas: ",
