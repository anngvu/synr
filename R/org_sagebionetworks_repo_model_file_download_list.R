  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`filesToDownload`)) {
        self$`filesToDownload` <- ApiClient$new()$deserializeObj(this_object$`filesToDownload`, "array[OrgSagebionetworksRepoModelFileFileHandleAssociation]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
