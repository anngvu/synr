  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`partPresignedUrls`)) {
        self$`partPresignedUrls` <- ApiClient$new()$deserializeObj(this_object$`partPresignedUrls`, "array[OrgSagebionetworksRepoModelFilePartPresignedUrl]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
