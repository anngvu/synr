...
OrgSagebionetworksRepoModelSearchDocument <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`type`, `id`, `fields` = NULL, ...) {
      if (!missing(`type`)) {
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelSearchDocument: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelSearchDocument: the required field `id` is missing."))
      }
    },
