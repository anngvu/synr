...
.parse_org.sagebionetworks.repo.model.ACCESS_TYPE <- function(vals) {
  res <- gsub("^\\[|\\]$", "", "[CREATE, READ, UPDATE, DELETE, CHANGE_PERMISSIONS, DOWNLOAD, UPLOAD, PARTICIPATE, SUBMIT, READ_PRIVATE_SUBMISSION, UPDATE_SUBMISSION, DELETE_SUBMISSION, TEAM_MEMBERSHIP_UPDATE, SEND_MESSAGE, CHANGE_SETTINGS, MODERATE, REVIEW_SUBMISSIONS, EXEMPTION_ELIGIBLE]")
  unlist(strsplit(res, ", "))
}
