...
#' @description PaginatedResultsOfMessageToUser Class
#' @format An \code{R6Class} generator object
#' @field totalNumberOfResults  integer [optional]
#' @field results  list(\link{OrgSagebionetworksRepoModelMessageMessageToUser}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedResultsOfMessageToUser <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return PaginatedResultsOfMessageToUser in JSON format
    #' @export
    toJSON = function() {
      PaginatedResultsOfMessageToUserObject <- list()
      if (!is.null(self$`totalNumberOfResults`)) {
        PaginatedResultsOfMessageToUserObject[["totalNumberOfResults"]] <-
          self$`totalNumberOfResults`
      }
      if (!is.null(self$`results`)) {
        PaginatedResultsOfMessageToUserObject[["results"]] <-
          lapply(self$`results`, function(x) x$toJSON())
      }
      PaginatedResultsOfMessageToUserObject
    },
    ...
    #' @return the instance of PaginatedResultsOfMessageToUser
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[OrgSagebionetworksRepoModelMessageMessageToUser]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to PaginatedResultsOfMessageToUser
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PaginatedResultsOfMessageToUser
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedResultsOfMessageToUser$unlock()
#
## Below is an example to define the print function
# PaginatedResultsOfMessageToUser$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedResultsOfMessageToUser$lock()
