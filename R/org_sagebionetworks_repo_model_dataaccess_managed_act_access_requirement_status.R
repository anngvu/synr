...
OrgSagebionetworksRepoModelDataaccessManagedACTAccessRequirementStatus <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`concreteType`, `accessRequirementId` = NULL, `isApproved` = NULL, `expiredOn` = NULL, `currentSubmissionStatus` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus\".", sep = ""))
        }
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelDataaccessManagedACTAccessRequirementStatus: the required field `concreteType` is missing."))
      }
    },
