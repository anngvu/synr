  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`batchToRemove`)) {
        self$`batchToRemove` <- ApiClient$new()$deserializeObj(this_object$`batchToRemove`, "array[OrgSagebionetworksRepoModelDownloadDownloadListItem]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
