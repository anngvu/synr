...
#' @field results  list(\link{OrgSagebionetworksRepoModelAccessRequirement}) [optional]
...
PaginatedResultsOfAccessRequirement <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return PaginatedResultsOfAccessRequirement in JSON format
    #' @export
    toJSON = function() {
    ...
    #' @return the instance of PaginatedResultsOfAccessRequirement
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[OrgSagebionetworksRepoModelAccessRequirement]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to PaginatedResultsOfAccessRequirement
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PaginatedResultsOfAccessRequirement
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedResultsOfAccessRequirement$unlock()
#
## Below is an example to define the print function
# PaginatedResultsOfAccessRequirement$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedResultsOfAccessRequirement$lock()
