  ...
  public = list(
    ...
    getRepoV1MembershipInvitationIdWithHttpInfo = function(id, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelMembershipInvitation", loadNamespace("synr")),
          error = function(e) {
    ...
    getRepoV1MembershipInvitationIdInviteeVerificationSignedTokenWithHttpInfo = function(id, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelInviteeVerificationSignedToken", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1TeamIdOpenInvitationWithHttpInfo = function(id, invitee_id = NULL, limit = NULL, offset = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "PaginatedResultsOfMembershipInvitation", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
