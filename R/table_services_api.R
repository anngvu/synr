  ...
  public = list(
    ...
    getRepoV1ColumnWithHttpInfo = function(prefix = NULL, limit = NULL, offset = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTablePaginatedColumnModels", loadNamespace("synr")),
          error = function(e) {
    ...
    getRepoV1ColumnColumnIdWithHttpInfo = function(column_id, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableColumnModel", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1ColumnTableviewDefaultsWithHttpInfo = function(view_entity_type = NULL, view_type_mask = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "ListWrapperOfColumnModel", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1ColumnViewScopeAsyncGetAsyncTokenWithHttpInfo = function(async_token, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableViewColumnModelResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1EntityIdTableDownloadCsvAsyncGetAsyncTokenWithHttpInfo = function(id, async_token, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableDownloadFromTableResult", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1EntityIdTableQueryAsyncGetAsyncTokenWithHttpInfo = function(id, async_token, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableQueryResultBundle", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1EntityIdTableTransactionAsyncGetAsyncTokenWithHttpInfo = function(id, async_token, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableTableUpdateTransactionResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1EntityIdTableUploadCsvAsyncGetAsyncTokenWithHttpInfo = function(id, async_token, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableUploadToTableResult", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    getRepoV1TableUploadCsvPreviewAsyncGetAsyncTokenWithHttpInfo = function(async_token, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableUploadToTablePreviewResult", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1EntityIdTableFilehandlesWithHttpInfo = function(id, org_sagebionetworks_repo_model_table_row_reference_set, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableTableFileHandleResults", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1EntityIdTableSnapshotWithHttpInfo = function(id, org_sagebionetworks_repo_model_table_snapshot_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableSnapshotResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1ValidateDefiningSqlWithHttpInfo = function(org_sagebionetworks_repo_model_table_validate_defining_sql_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelTableValidateDefiningSqlResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
