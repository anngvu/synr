  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`checksums`)) {
        self$`checksums` <- ApiClient$new()$deserializeObj(this_object$`checksums`, "array[OrgSagebionetworksRepoModelDrsChecksum]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`contents`)) {
        self$`contents` <- ApiClient$new()$deserializeObj(this_object$`contents`, "array[OrgSagebionetworksRepoModelDrsContent]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`access_methods`)) {
        self$`access_methods` <- ApiClient$new()$deserializeObj(this_object$`access_methods`, "array[OrgSagebionetworksRepoModelDrsAccessMethod]", loadNamespace("synr"))
      }
