...
.parse_org.sagebionetworks.repo.model.feature.Feature <- function(vals) {
  res <- gsub("^\\[|\\]$", "", "[DATA_ACCESS_NOTIFICATIONS, DATA_ACCESS_AUTO_REVOCATION, MULTIPART_AUTO_CLEANUP, DATA_DOWNLOAD_THROUGH_CLOUDFRONT, UPLOAD_LOCK_NOWAIT, CHANGE_PASSWORD_2FA_CHECK_BYPASS]")
  unlist(strsplit(res, ", "))
}
