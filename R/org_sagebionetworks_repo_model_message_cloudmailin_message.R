  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`attachments`)) {
        self$`attachments` <- ApiClient$new()$deserializeObj(this_object$`attachments`, "array[OrgSagebionetworksRepoModelMessageCloudmailinAttachment]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
