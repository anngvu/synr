...
#' @field results  list(\link{OrgSagebionetworksRepoModelReference}) [optional]
...
PaginatedResultsOfReference <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return PaginatedResultsOfReference in JSON format
    #' @export
    toJSON = function() {
    ...
    #' @return the instance of PaginatedResultsOfReference
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[OrgSagebionetworksRepoModelReference]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to PaginatedResultsOfReference
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PaginatedResultsOfReference
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedResultsOfReference$unlock()
#
## Below is an example to define the print function
# PaginatedResultsOfReference$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedResultsOfReference$lock()
