#' Create a new OrgSagebionetworksRepoModelTermsOfUseAccessRequirement
#'
#' @description
#' JSON schema for Terms of Use Access Requirement, used for a 'tier 2' Access Requirement
#'
#' @docType class
#' @title OrgSagebionetworksRepoModelTermsOfUseAccessRequirement
#' @description OrgSagebionetworksRepoModelTermsOfUseAccessRequirement Class
...
#' @field termsOfUse  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
OrgSagebionetworksRepoModelTermsOfUseAccessRequirement <- R6::R6Class(
  ...
  public = list(
    ...
    `concreteType` = NULL,
    `termsOfUse` = NULL,
    #' Initialize a new OrgSagebionetworksRepoModelTermsOfUseAccessRequirement class.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelTermsOfUseAccessRequirement class.
    #'
    ...
    #' @export
    initialize = function(`concreteType`, `versionNumber` = NULL, `id` = NULL, `description` = NULL, `name` = NULL, `etag` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `subjectsDefinedByAnnotations` = NULL, `subjectIds` = NULL, `accessType` = NULL, `termsOfUse` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.TermsOfUseAccessRequirement"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.TermsOfUseAccessRequirement\".", sep = ""))
        }
      ...
      if (!is.null(`termsOfUse`)) {
        if (!(is.character(`termsOfUse`) && length(`termsOfUse`) == 1)) {
          stop(paste("Error! Invalid data for `termsOfUse`. Must be a string:", `termsOfUse`))
        }
    ...
    #' To JSON String
    #'
    #' @return OrgSagebionetworksRepoModelTermsOfUseAccessRequirement in JSON format
    #' @export
    toJSON = function() {
      OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject <- list()
      if (!is.null(self$`versionNumber`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["versionNumber"]] <-
          self$`versionNumber`
      }
      if (!is.null(self$`id`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`description`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`name`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`etag`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["etag"]] <-
          self$`etag`
      }
      if (!is.null(self$`createdOn`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["createdOn"]] <-
          self$`createdOn`
      }
      if (!is.null(self$`modifiedOn`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["modifiedOn"]] <-
          self$`modifiedOn`
      }
      if (!is.null(self$`createdBy`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`subjectsDefinedByAnnotations`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["subjectsDefinedByAnnotations"]] <-
          self$`subjectsDefinedByAnnotations`
      }
      if (!is.null(self$`subjectIds`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["subjectIds"]] <-
          lapply(self$`subjectIds`, function(x) x$toJSON())
      }
      if (!is.null(self$`accessType`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["accessType"]] <-
          self$`accessType`
      }
      if (!is.null(self$`concreteType`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["concreteType"]] <-
          self$`concreteType`
      }
      if (!is.null(self$`termsOfUse`)) {
        OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject[["termsOfUse"]] <-
          self$`termsOfUse`
      }
      OrgSagebionetworksRepoModelTermsOfUseAccessRequirementObject
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelTermsOfUseAccessRequirement
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelTermsOfUseAccessRequirement
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrgSagebionetworksRepoModelTermsOfUseAccessRequirement
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.TermsOfUseAccessRequirement"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.TermsOfUseAccessRequirement\".", sep = ""))
        }
        self$`concreteType` <- this_object$`concreteType`
      }
      if (!is.null(this_object$`termsOfUse`)) {
        self$`termsOfUse` <- this_object$`termsOfUse`
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelTermsOfUseAccessRequirement
    #'
    #' @description
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelTermsOfUseAccessRequirement and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelTermsOfUseAccessRequirement: the required field `concreteType` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrgSagebionetworksRepoModelTermsOfUseAccessRequirement
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrgSagebionetworksRepoModelTermsOfUseAccessRequirement$unlock()
#
## Below is an example to define the print function
# OrgSagebionetworksRepoModelTermsOfUseAccessRequirement$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrgSagebionetworksRepoModelTermsOfUseAccessRequirement$lock()
