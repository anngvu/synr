#' Create a new OrgSagebionetworksRepoModelDataaccessRequest
#'
#' @description
#' A Request contains information required by an AccessRequirement.
#'
#' @docType class
#' @title OrgSagebionetworksRepoModelDataaccessRequest
#' @description OrgSagebionetworksRepoModelDataaccessRequest Class
...
#' @export
OrgSagebionetworksRepoModelDataaccessRequest <- R6::R6Class(
  ...
  public = list(
    ...
    `etag` = NULL,
    `concreteType` = NULL,
    #' Initialize a new OrgSagebionetworksRepoModelDataaccessRequest class.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelDataaccessRequest class.
    #'
    ...
    #' @export
    initialize = function(`concreteType`, `id` = NULL, `accessRequirementId` = NULL, `researchProjectId` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `ducFileHandleId` = NULL, `irbFileHandleId` = NULL, `attachments` = NULL, `accessorChanges` = NULL, `etag` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.dataaccess.Request"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.dataaccess.Request\".", sep = ""))
        }
    ...
    #' To JSON String
    #'
    #' @return OrgSagebionetworksRepoModelDataaccessRequest in JSON format
    #' @export
    toJSON = function() {
      OrgSagebionetworksRepoModelDataaccessRequestObject <- list()
      if (!is.null(self$`id`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`accessRequirementId`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["accessRequirementId"]] <-
          self$`accessRequirementId`
      }
      if (!is.null(self$`researchProjectId`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["researchProjectId"]] <-
          self$`researchProjectId`
      }
      if (!is.null(self$`createdOn`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["createdOn"]] <-
          self$`createdOn`
      }
      if (!is.null(self$`modifiedOn`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["modifiedOn"]] <-
          self$`modifiedOn`
      }
      if (!is.null(self$`createdBy`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`ducFileHandleId`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["ducFileHandleId"]] <-
          self$`ducFileHandleId`
      }
      if (!is.null(self$`irbFileHandleId`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["irbFileHandleId"]] <-
          self$`irbFileHandleId`
      }
      if (!is.null(self$`attachments`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["attachments"]] <-
          self$`attachments`
      }
      if (!is.null(self$`accessorChanges`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["accessorChanges"]] <-
          lapply(self$`accessorChanges`, function(x) x$toJSON())
      }
      if (!is.null(self$`etag`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["etag"]] <-
          self$`etag`
      }
      if (!is.null(self$`concreteType`)) {
        OrgSagebionetworksRepoModelDataaccessRequestObject[["concreteType"]] <-
          self$`concreteType`
      }
      OrgSagebionetworksRepoModelDataaccessRequestObject
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelDataaccessRequest
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelDataaccessRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrgSagebionetworksRepoModelDataaccessRequest
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`attachments`)) {
        self$`attachments` <- ApiClient$new()$deserializeObj(this_object$`attachments`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`accessorChanges`)) {
        self$`accessorChanges` <- ApiClient$new()$deserializeObj(this_object$`accessorChanges`, "array[OrgSagebionetworksRepoModelDataaccessAccessorChange]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`etag`)) {
        self$`etag` <- this_object$`etag`
      }
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.dataaccess.Request"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.dataaccess.Request\".", sep = ""))
        }
...
',
    ...
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelDataaccessRequest
    #'
    #' @description
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelDataaccessRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelDataaccessRequest: the required field `concreteType` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrgSagebionetworksRepoModelDataaccessRequest
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrgSagebionetworksRepoModelDataaccessRequest$unlock()
#
## Below is an example to define the print function
# OrgSagebionetworksRepoModelDataaccessRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrgSagebionetworksRepoModelDataaccessRequest$lock()
