...
#' @field results  list(\link{OrgSagebionetworksRepoModelUserProfile}) [optional]
...
PaginatedResultsOfUserProfile <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return PaginatedResultsOfUserProfile in JSON format
    #' @export
    toJSON = function() {
    ...
    #' @return the instance of PaginatedResultsOfUserProfile
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[OrgSagebionetworksRepoModelUserProfile]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to PaginatedResultsOfUserProfile
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PaginatedResultsOfUserProfile
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedResultsOfUserProfile$unlock()
#
## Below is an example to define the print function
# PaginatedResultsOfUserProfile$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedResultsOfUserProfile$lock()
