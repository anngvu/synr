  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`membersEligibility`)) {
        self$`membersEligibility` <- ApiClient$new()$deserializeObj(this_object$`membersEligibility`, "array[OrgSagebionetworksEvaluationModelMemberSubmissionEligibility]", loadNamespace("synr"))
      }
