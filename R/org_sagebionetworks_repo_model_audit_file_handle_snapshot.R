...
OrgSagebionetworksRepoModelAuditFileHandleSnapshot <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`concreteType`, `id` = NULL, `createdBy` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `contentMd5` = NULL, `contentType` = NULL, `fileName` = NULL, `storageLocationId` = NULL, `contentSize` = NULL, `key` = NULL, `bucket` = NULL, `previewId` = NULL, `isPreview` = NULL, `status` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.audit.FileHandleSnapshot"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.audit.FileHandleSnapshot\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.audit.FileHandleSnapshot"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.audit.FileHandleSnapshot\".", sep = ""))
        }
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelAuditFileHandleSnapshot: the required field `concreteType` is missing."))
      }
    },
