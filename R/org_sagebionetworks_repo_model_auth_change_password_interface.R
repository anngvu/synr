...
OrgSagebionetworksRepoModelAuthChangePasswordInterface <- R6::R6Class(
  ...
  public = list(
    ...
    one_of = list("OrgSagebionetworksRepoModelAuthChangePasswordWithCurrentPassword", "OrgSagebionetworksRepoModelAuthChangePasswordWithToken", "OrgSagebionetworksRepoModelAuthChangePasswordWithTwoFactorAuthToken"),
    #' Initialize a new OrgSagebionetworksRepoModelAuthChangePasswordInterface.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelAuthChangePasswordInterface.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "OrgSagebionetworksRepoModelAuthChangePasswordWithCurrentPassword", "OrgSagebionetworksRepoModelAuthChangePasswordWithToken", "OrgSagebionetworksRepoModelAuthChangePasswordWithTwoFactorAuthToken"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize OrgSagebionetworksRepoModelAuthChangePasswordInterface with oneOf schemas OrgSagebionetworksRepoModelAuthChangePasswordWithCurrentPassword, OrgSagebionetworksRepoModelAuthChangePasswordWithToken, OrgSagebionetworksRepoModelAuthChangePasswordWithTwoFactorAuthToken. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into OrgSagebionetworksRepoModelAuthChangePasswordInterface with oneOf schemas OrgSagebionetworksRepoModelAuthChangePasswordWithCurrentPassword, OrgSagebionetworksRepoModelAuthChangePasswordWithToken, OrgSagebionetworksRepoModelAuthChangePasswordWithTwoFactorAuthToken. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into OrgSagebionetworksRepoModelAuthChangePasswordInterface with oneOf schemas OrgSagebionetworksRepoModelAuthChangePasswordWithCurrentPassword, OrgSagebionetworksRepoModelAuthChangePasswordWithToken, OrgSagebionetworksRepoModelAuthChangePasswordWithTwoFactorAuthToken. Details: >>",
