...
OrgSagebionetworksRepoModelFileExternalObjectStoreFileHandle <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`concreteType`, `fileKey`, `id` = NULL, `etag` = NULL, `createdBy` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `contentType` = NULL, `contentMd5` = NULL, `fileName` = NULL, `storageLocationId` = NULL, `contentSize` = NULL, `status` = NULL, `endpointUrl` = NULL, `bucket` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.file.ExternalObjectStoreFileHandle"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.file.ExternalObjectStoreFileHandle\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.file.ExternalObjectStoreFileHandle"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.file.ExternalObjectStoreFileHandle\".", sep = ""))
        }
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelFileExternalObjectStoreFileHandle: the required field `concreteType` is missing."))
      }
      # check the required field `fileKey`
      if (!is.null(input_json$`fileKey`)) {
        if (!(is.character(input_json$`fileKey`) && length(input_json$`fileKey`) == 1)) {
          stop(paste("Error! Invalid data for `fileKey`. Must be a string:", input_json$`fileKey`))
        }
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelFileExternalObjectStoreFileHandle: the required field `fileKey` is missing."))
      }
    },
    ...
    isValid = function() {
      ...
      # check if the required `fileKey` is null
      if (is.null(self$`fileKey`)) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      # check if the required `fileKey` is null
      if (is.null(self$`fileKey`)) {
        invalid_fields["fileKey"] <- "Non-nullable required field `fileKey` cannot be null."
      }
