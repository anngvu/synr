  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`contributors`)) {
        self$`contributors` <- ApiClient$new()$deserializeObj(this_object$`contributors`, "array[OrgSagebionetworksEvaluationModelSubmissionContributor]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
