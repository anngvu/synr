#' Create a new OrgSagebionetworksRepoModelNode
#'
#' @description
#' This is the DTO of a node.
#'
#' @docType class
#' @title OrgSagebionetworksRepoModelNode
#' @description OrgSagebionetworksRepoModelNode Class
...
#' @export
OrgSagebionetworksRepoModelNode <- R6::R6Class(
  "OrgSagebionetworksRepoModelNode",
  public = list(
    `id` = NULL,
    `name` = NULL,
    `description` = NULL,
    ...
    `definingSQL` = NULL,
    #' Initialize a new OrgSagebionetworksRepoModelNode class.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelNode class.
    #'
    ...
    #' To JSON String
    #'
    #' @return OrgSagebionetworksRepoModelNode in JSON format
    #' @export
    toJSON = function() {
      OrgSagebionetworksRepoModelNodeObject <- list()
      if (!is.null(self$`id`)) {
        OrgSagebionetworksRepoModelNodeObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        OrgSagebionetworksRepoModelNodeObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`description`)) {
        OrgSagebionetworksRepoModelNodeObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`parentId`)) {
        OrgSagebionetworksRepoModelNodeObject[["parentId"]] <-
          self$`parentId`
      }
      if (!is.null(self$`createdByPrincipalId`)) {
        OrgSagebionetworksRepoModelNodeObject[["createdByPrincipalId"]] <-
          self$`createdByPrincipalId`
      }
      if (!is.null(self$`createdOn`)) {
        OrgSagebionetworksRepoModelNodeObject[["createdOn"]] <-
          self$`createdOn`
      }
      if (!is.null(self$`modifiedByPrincipalId`)) {
        OrgSagebionetworksRepoModelNodeObject[["modifiedByPrincipalId"]] <-
          self$`modifiedByPrincipalId`
      }
      if (!is.null(self$`modifiedOn`)) {
        OrgSagebionetworksRepoModelNodeObject[["modifiedOn"]] <-
          self$`modifiedOn`
      }
      if (!is.null(self$`nodeType`)) {
        OrgSagebionetworksRepoModelNodeObject[["nodeType"]] <-
          self$`nodeType`
      }
      if (!is.null(self$`eTag`)) {
        OrgSagebionetworksRepoModelNodeObject[["eTag"]] <-
          self$`eTag`
      }
      if (!is.null(self$`versionNumber`)) {
        OrgSagebionetworksRepoModelNodeObject[["versionNumber"]] <-
          self$`versionNumber`
      }
      if (!is.null(self$`versionComment`)) {
        OrgSagebionetworksRepoModelNodeObject[["versionComment"]] <-
          self$`versionComment`
      }
      if (!is.null(self$`versionLabel`)) {
        OrgSagebionetworksRepoModelNodeObject[["versionLabel"]] <-
          self$`versionLabel`
      }
      if (!is.null(self$`isLatestVersion`)) {
        OrgSagebionetworksRepoModelNodeObject[["isLatestVersion"]] <-
          self$`isLatestVersion`
      }
      if (!is.null(self$`activityId`)) {
        OrgSagebionetworksRepoModelNodeObject[["activityId"]] <-
          self$`activityId`
      }
      if (!is.null(self$`fileHandleId`)) {
        OrgSagebionetworksRepoModelNodeObject[["fileHandleId"]] <-
          self$`fileHandleId`
      }
      if (!is.null(self$`columnModelIds`)) {
        OrgSagebionetworksRepoModelNodeObject[["columnModelIds"]] <-
          self$`columnModelIds`
      }
      if (!is.null(self$`scopeIds`)) {
        OrgSagebionetworksRepoModelNodeObject[["scopeIds"]] <-
          self$`scopeIds`
      }
      if (!is.null(self$`items`)) {
        OrgSagebionetworksRepoModelNodeObject[["items"]] <-
          lapply(self$`items`, function(x) x$toJSON())
      }
      if (!is.null(self$`reference`)) {
        OrgSagebionetworksRepoModelNodeObject[["reference"]] <-
          self$`reference`$toJSON()
      }
      if (!is.null(self$`alias`)) {
        OrgSagebionetworksRepoModelNodeObject[["alias"]] <-
          self$`alias`
      }
      if (!is.null(self$`isSearchEnabled`)) {
        OrgSagebionetworksRepoModelNodeObject[["isSearchEnabled"]] <-
          self$`isSearchEnabled`
      }
      if (!is.null(self$`definingSQL`)) {
        OrgSagebionetworksRepoModelNodeObject[["definingSQL"]] <-
          self$`definingSQL`
      }
      OrgSagebionetworksRepoModelNodeObject
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelNode
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelNode
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrgSagebionetworksRepoModelNode
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`columnModelIds`)) {
        self$`columnModelIds` <- ApiClient$new()$deserializeObj(this_object$`columnModelIds`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`scopeIds`)) {
        self$`scopeIds` <- ApiClient$new()$deserializeObj(this_object$`scopeIds`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[OrgSagebionetworksRepoModelEntityRef]", loadNamespace("synr"))
      }
...
',
    ...
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelNode
    #'
    #' @description
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelNode and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrgSagebionetworksRepoModelNode
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrgSagebionetworksRepoModelNode$unlock()
#
## Below is an example to define the print function
# OrgSagebionetworksRepoModelNode$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrgSagebionetworksRepoModelNode$lock()
