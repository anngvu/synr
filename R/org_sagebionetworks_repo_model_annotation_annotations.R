  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`stringAnnos`)) {
        self$`stringAnnos` <- ApiClient$new()$deserializeObj(this_object$`stringAnnos`, "array[OrgSagebionetworksRepoModelAnnotationStringAnnotation]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`longAnnos`)) {
        self$`longAnnos` <- ApiClient$new()$deserializeObj(this_object$`longAnnos`, "array[OrgSagebionetworksRepoModelAnnotationLongAnnotation]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`doubleAnnos`)) {
        self$`doubleAnnos` <- ApiClient$new()$deserializeObj(this_object$`doubleAnnos`, "array[OrgSagebionetworksRepoModelAnnotationDoubleAnnotation]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
