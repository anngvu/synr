  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`openIds`)) {
        self$`openIds` <- ApiClient$new()$deserializeObj(this_object$`openIds`, "array[character]", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`preferences`)) {
        self$`preferences` <- ApiClient$new()$deserializeObj(this_object$`preferences`, "array[OrgSagebionetworksRepoModelUserPreference]", loadNamespace("synr"))
      }
