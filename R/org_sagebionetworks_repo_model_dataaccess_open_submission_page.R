  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`openSubmissionList`)) {
        self$`openSubmissionList` <- ApiClient$new()$deserializeObj(this_object$`openSubmissionList`, "array[OrgSagebionetworksRepoModelDataaccessOpenSubmission]", loadNamespace("synr"))
      }
