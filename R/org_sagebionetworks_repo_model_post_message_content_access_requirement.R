#' Create a new OrgSagebionetworksRepoModelPostMessageContentAccessRequirement
#'
#' @description
#' This class is deprecated and should not being used.
#'
#' @docType class
#' @title OrgSagebionetworksRepoModelPostMessageContentAccessRequirement
#' @description OrgSagebionetworksRepoModelPostMessageContentAccessRequirement Class
...
#' @export
OrgSagebionetworksRepoModelPostMessageContentAccessRequirement <- R6::R6Class(
  ...
  public = list(
    ...
    `concreteType` = NULL,
    `url` = NULL,
    #' Initialize a new OrgSagebionetworksRepoModelPostMessageContentAccessRequirement class.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelPostMessageContentAccessRequirement class.
    #'
    ...
    #' @export
    initialize = function(`concreteType`, `versionNumber` = NULL, `id` = NULL, `description` = NULL, `name` = NULL, `etag` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `subjectsDefinedByAnnotations` = NULL, `subjectIds` = NULL, `accessType` = NULL, `url` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.PostMessageContentAccessRequirement"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.PostMessageContentAccessRequirement\".", sep = ""))
        }
    ...
    #' To JSON String
    #'
    #' @return OrgSagebionetworksRepoModelPostMessageContentAccessRequirement in JSON format
    #' @export
    toJSON = function() {
      OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject <- list()
      if (!is.null(self$`versionNumber`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["versionNumber"]] <-
          self$`versionNumber`
      }
      if (!is.null(self$`id`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`description`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`name`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`etag`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["etag"]] <-
          self$`etag`
      }
      if (!is.null(self$`createdOn`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["createdOn"]] <-
          self$`createdOn`
      }
      if (!is.null(self$`modifiedOn`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["modifiedOn"]] <-
          self$`modifiedOn`
      }
      if (!is.null(self$`createdBy`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`subjectsDefinedByAnnotations`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["subjectsDefinedByAnnotations"]] <-
          self$`subjectsDefinedByAnnotations`
      }
      if (!is.null(self$`subjectIds`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["subjectIds"]] <-
          lapply(self$`subjectIds`, function(x) x$toJSON())
      }
      if (!is.null(self$`accessType`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["accessType"]] <-
          self$`accessType`
      }
      if (!is.null(self$`concreteType`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["concreteType"]] <-
          self$`concreteType`
      }
      if (!is.null(self$`url`)) {
        OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject[["url"]] <-
          self$`url`
      }
      OrgSagebionetworksRepoModelPostMessageContentAccessRequirementObject
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelPostMessageContentAccessRequirement
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelPostMessageContentAccessRequirement
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrgSagebionetworksRepoModelPostMessageContentAccessRequirement
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.PostMessageContentAccessRequirement"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.PostMessageContentAccessRequirement\".", sep = ""))
        }
...
',
    ...
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelPostMessageContentAccessRequirement
    #'
    #' @description
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelPostMessageContentAccessRequirement and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelPostMessageContentAccessRequirement: the required field `concreteType` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrgSagebionetworksRepoModelPostMessageContentAccessRequirement
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrgSagebionetworksRepoModelPostMessageContentAccessRequirement$unlock()
#
## Below is an example to define the print function
# OrgSagebionetworksRepoModelPostMessageContentAccessRequirement$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrgSagebionetworksRepoModelPostMessageContentAccessRequirement$lock()
