  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`queryTerm`)) {
        self$`queryTerm` <- ApiClient$new()$deserializeObj(this_object$`queryTerm`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`booleanQuery`)) {
        self$`booleanQuery` <- ApiClient$new()$deserializeObj(this_object$`booleanQuery`, "array[OrgSagebionetworksRepoModelSearchQueryKeyValue]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`rangeQuery`)) {
        self$`rangeQuery` <- ApiClient$new()$deserializeObj(this_object$`rangeQuery`, "array[OrgSagebionetworksRepoModelSearchQueryKeyRange]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`facetOptions`)) {
        self$`facetOptions` <- ApiClient$new()$deserializeObj(this_object$`facetOptions`, "array[OrgSagebionetworksRepoModelSearchQuerySearchFacetOption]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`returnFields`)) {
        self$`returnFields` <- ApiClient$new()$deserializeObj(this_object$`returnFields`, "array[character]", loadNamespace("synr"))
      }
