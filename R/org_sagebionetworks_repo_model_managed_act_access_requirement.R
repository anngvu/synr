...
OrgSagebionetworksRepoModelManagedACTAccessRequirement <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`concreteType`, `versionNumber` = NULL, `id` = NULL, `description` = NULL, `name` = NULL, `etag` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `subjectsDefinedByAnnotations` = NULL, `subjectIds` = NULL, `accessType` = NULL, `isCertifiedUserRequired` = NULL, `isValidatedProfileRequired` = NULL, `isDUCRequired` = NULL, `ducTemplateFileHandleId` = NULL, `isIRBApprovalRequired` = NULL, `areOtherAttachmentsRequired` = NULL, `expirationPeriod` = NULL, `isIDUPublic` = NULL, `isIDURequired` = NULL, `isTwoFaRequired` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.ManagedACTAccessRequirement"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.ManagedACTAccessRequirement\".", sep = ""))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.ManagedACTAccessRequirement"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.ManagedACTAccessRequirement\".", sep = ""))
        }
...
',
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelManagedACTAccessRequirement: the required field `concreteType` is missing."))
      }
    },
