#' Create a new OrgSagebionetworksRepoModelSelfSignAccessRequirement
#'
#' @description
#' JSON schema for Terms of Use Access Requirement, used for a 'tier 2' Access Requirement
#'
#' @docType class
#' @title OrgSagebionetworksRepoModelSelfSignAccessRequirement
#' @description OrgSagebionetworksRepoModelSelfSignAccessRequirement Class
...
#' @export
OrgSagebionetworksRepoModelSelfSignAccessRequirement <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new OrgSagebionetworksRepoModelSelfSignAccessRequirement class.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelSelfSignAccessRequirement class.
    #'
    ...
    #' @export
    initialize = function(`concreteType`, `versionNumber` = NULL, `id` = NULL, `description` = NULL, `name` = NULL, `etag` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `subjectsDefinedByAnnotations` = NULL, `subjectIds` = NULL, `accessType` = NULL, `isCertifiedUserRequired` = NULL, `isValidatedProfileRequired` = NULL, ...) {
      if (!missing(`concreteType`)) {
        if (!(`concreteType` %in% c("org.sagebionetworks.repo.model.SelfSignAccessRequirement"))) {
          stop(paste("Error! \"", `concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.SelfSignAccessRequirement\".", sep = ""))
        }
    ...
    #' To JSON String
    #'
    #' @return OrgSagebionetworksRepoModelSelfSignAccessRequirement in JSON format
    #' @export
    toJSON = function() {
      OrgSagebionetworksRepoModelSelfSignAccessRequirementObject <- list()
      if (!is.null(self$`versionNumber`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["versionNumber"]] <-
          self$`versionNumber`
      }
      if (!is.null(self$`id`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`description`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`name`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`etag`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["etag"]] <-
          self$`etag`
      }
      if (!is.null(self$`createdOn`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["createdOn"]] <-
          self$`createdOn`
      }
      if (!is.null(self$`modifiedOn`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["modifiedOn"]] <-
          self$`modifiedOn`
      }
      if (!is.null(self$`createdBy`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["createdBy"]] <-
          self$`createdBy`
      }
      if (!is.null(self$`modifiedBy`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["modifiedBy"]] <-
          self$`modifiedBy`
      }
      if (!is.null(self$`subjectsDefinedByAnnotations`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["subjectsDefinedByAnnotations"]] <-
          self$`subjectsDefinedByAnnotations`
      }
      if (!is.null(self$`subjectIds`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["subjectIds"]] <-
          lapply(self$`subjectIds`, function(x) x$toJSON())
      }
      if (!is.null(self$`accessType`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["accessType"]] <-
          self$`accessType`
      }
      if (!is.null(self$`concreteType`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["concreteType"]] <-
          self$`concreteType`
      }
      if (!is.null(self$`isCertifiedUserRequired`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["isCertifiedUserRequired"]] <-
          self$`isCertifiedUserRequired`
      }
      if (!is.null(self$`isValidatedProfileRequired`)) {
        OrgSagebionetworksRepoModelSelfSignAccessRequirementObject[["isValidatedProfileRequired"]] <-
          self$`isValidatedProfileRequired`
      }
      OrgSagebionetworksRepoModelSelfSignAccessRequirementObject
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelSelfSignAccessRequirement
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelSelfSignAccessRequirement
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrgSagebionetworksRepoModelSelfSignAccessRequirement
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`concreteType`)) {
        if (!is.null(this_object$`concreteType`) && !(this_object$`concreteType` %in% c("org.sagebionetworks.repo.model.SelfSignAccessRequirement"))) {
          stop(paste("Error! \"", this_object$`concreteType`, "\" cannot be assigned to `concreteType`. Must be \"org.sagebionetworks.repo.model.SelfSignAccessRequirement\".", sep = ""))
        }
...
',
    ...
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelSelfSignAccessRequirement
    #'
    #' @description
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelSelfSignAccessRequirement and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`concreteType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrgSagebionetworksRepoModelSelfSignAccessRequirement: the required field `concreteType` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrgSagebionetworksRepoModelSelfSignAccessRequirement
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrgSagebionetworksRepoModelSelfSignAccessRequirement$unlock()
#
## Below is an example to define the print function
# OrgSagebionetworksRepoModelSelfSignAccessRequirement$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrgSagebionetworksRepoModelSelfSignAccessRequirement$lock()
