...
#' @field results  list(\link{OrgSagebionetworksRepoModelTrashedEntity}) [optional]
...
PaginatedResultsOfTrashedEntity <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return PaginatedResultsOfTrashedEntity in JSON format
    #' @export
    toJSON = function() {
    ...
    #' @return the instance of PaginatedResultsOfTrashedEntity
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[OrgSagebionetworksRepoModelTrashedEntity]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
...
',
    ...
    #' Validate JSON input with respect to PaginatedResultsOfTrashedEntity
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PaginatedResultsOfTrashedEntity
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedResultsOfTrashedEntity$unlock()
#
## Below is an example to define the print function
# PaginatedResultsOfTrashedEntity$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedResultsOfTrashedEntity$lock()
