...
#' @field includeActivity  character [optional]
...
OrgSagebionetworksRepoModelEntitybundleV2EntityBundleRequest <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`includeEntity` = NULL, `includeAnnotations` = NULL, `includePermissions` = NULL, `includeEntityPath` = NULL, `includeHasChildren` = NULL, `includeAccessControlList` = NULL, `includeFileHandles` = NULL, `includeTableBundle` = NULL, `includeRootWikiId` = NULL, `includeBenefactorACL` = NULL, `includeDOIAssociation` = NULL, `includeFileName` = NULL, `includeThreadCount` = NULL, `includeRestrictionInformation` = NULL, `includeActivity` = NULL, ...) {
      ...
      if (!is.null(`includeActivity`)) {
        if (!(is.logical(`includeActivity`) && length(`includeActivity`) == 1)) {
          stop(paste("Error! Invalid data for `includeActivity`. Must be a boolean:", `includeActivity`))
        }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`includeActivity`)) {
        OrgSagebionetworksRepoModelEntitybundleV2EntityBundleRequestObject[["includeActivity"]] <-
          self$`includeActivity`
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`includeActivity`)) {
        self$`includeActivity` <- this_object$`includeActivity`
      }
      self
    },
    #' To JSON string
