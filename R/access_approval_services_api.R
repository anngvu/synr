  ...
  public = list(
    ...
    getRepoV1AccessApprovalApprovalIdWithHttpInfo = function(approval_id, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelAccessApproval", loadNamespace("synr")),
          error = function(e) {
    ...
    postRepoV1AccessApprovalGroupWithHttpInfo = function(org_sagebionetworks_repo_model_dataaccess_accessor_group_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelDataaccessAccessorGroupResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1AccessApprovalInformationWithHttpInfo = function(org_sagebionetworks_repo_model_batch_access_approval_info_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelBatchAccessApprovalInfoResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1AccessApprovalNotificationsWithHttpInfo = function(org_sagebionetworks_repo_model_dataaccess_access_approval_notification_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelDataaccessAccessApprovalNotificationResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    postRepoV1AccessApprovalSearchWithHttpInfo = function(org_sagebionetworks_repo_model_dataaccess_access_approval_search_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "OrgSagebionetworksRepoModelDataaccessAccessApprovalSearchResponse", loadNamespace("synr")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
