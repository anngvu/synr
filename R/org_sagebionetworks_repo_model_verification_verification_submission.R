  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`emails`)) {
        self$`emails` <- ApiClient$new()$deserializeObj(this_object$`emails`, "array[character]", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`stateHistory`)) {
        self$`stateHistory` <- ApiClient$new()$deserializeObj(this_object$`stateHistory`, "array[OrgSagebionetworksRepoModelVerificationVerificationState]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`attachments`)) {
        self$`attachments` <- ApiClient$new()$deserializeObj(this_object$`attachments`, "array[OrgSagebionetworksRepoModelVerificationAttachmentMetadata]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
