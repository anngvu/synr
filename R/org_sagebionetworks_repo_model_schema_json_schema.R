  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`properties`)) {
        self$`properties` <- ApiClient$new()$deserializeObj(this_object$`properties`, "map(OrgSagebionetworksRepoModelSchemaJsonSchema)", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`allOf`)) {
        self$`allOf` <- ApiClient$new()$deserializeObj(this_object$`allOf`, "array[OrgSagebionetworksRepoModelSchemaJsonSchema]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`anyOf`)) {
        self$`anyOf` <- ApiClient$new()$deserializeObj(this_object$`anyOf`, "array[OrgSagebionetworksRepoModelSchemaJsonSchema]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`oneOf`)) {
        self$`oneOf` <- ApiClient$new()$deserializeObj(this_object$`oneOf`, "array[OrgSagebionetworksRepoModelSchemaJsonSchema]", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`definitions`)) {
        self$`definitions` <- ApiClient$new()$deserializeObj(this_object$`definitions`, "map(OrgSagebionetworksRepoModelSchemaJsonSchema)", loadNamespace("synr"))
      }
      if (!is.null(this_object$`enum`)) {
        self$`enum` <- ApiClient$new()$deserializeObj(this_object$`enum`, "array[AnyType]", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`required`)) {
        self$`required` <- ApiClient$new()$deserializeObj(this_object$`required`, "array[character]", loadNamespace("synr"))
      }
