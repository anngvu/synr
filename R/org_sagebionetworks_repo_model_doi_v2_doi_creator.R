  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`nameIdentifiers`)) {
        self$`nameIdentifiers` <- ApiClient$new()$deserializeObj(this_object$`nameIdentifiers`, "array[OrgSagebionetworksRepoModelDoiV2DoiNameIdentifier]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
