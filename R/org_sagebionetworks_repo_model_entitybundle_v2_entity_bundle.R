...
#' @field activity  \link{OrgSagebionetworksRepoModelProvenanceActivity} [optional]
...
OrgSagebionetworksRepoModelEntitybundleV2EntityBundle <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`entity` = NULL, `entityType` = NULL, `annotations` = NULL, `permissions` = NULL, `path` = NULL, `hasChildren` = NULL, `accessControlList` = NULL, `fileHandles` = NULL, `tableBundle` = NULL, `rootWikiId` = NULL, `benefactorAcl` = NULL, `doiAssociation` = NULL, `fileName` = NULL, `threadCount` = NULL, `restrictionInformation` = NULL, `activity` = NULL, ...) {
      if (!is.null(`entity`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`activity`)) {
        OrgSagebionetworksRepoModelEntitybundleV2EntityBundleObject[["activity"]] <-
          self$`activity`$toJSON()
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`fileHandles`)) {
        self$`fileHandles` <- ApiClient$new()$deserializeObj(this_object$`fileHandles`, "array[OrgSagebionetworksRepoModelFileFileHandle]", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`activity`)) {
        `activity_object` <- OrgSagebionetworksRepoModelProvenanceActivity$new()
        `activity_object`$fromJSON(jsonlite::toJSON(this_object$`activity`, auto_unbox = TRUE, digits = NA))
...
',
        ...
        if (!is.null(self$`activity`)) {
          ...
          %s
          ',
          jsonlite::toJSON(self$`activity`$toJSON(), auto_unbox = TRUE, digits = NA)
          )
        }
      )
    ...
    fromJSONString = function(input_json) {
      ...
      self$`activity` <- OrgSagebionetworksRepoModelProvenanceActivity$new()$fromJSON(jsonlite::toJSON(this_object$`activity`, auto_unbox = TRUE, digits = NA))
      self
    },
