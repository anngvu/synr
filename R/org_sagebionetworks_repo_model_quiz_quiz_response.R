  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`questionResponses`)) {
        self$`questionResponses` <- ApiClient$new()$deserializeObj(this_object$`questionResponses`, "array[OrgSagebionetworksRepoModelQuizQuestionResponse]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
