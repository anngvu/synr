  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`scopes_supported`)) {
        self$`scopes_supported` <- ApiClient$new()$deserializeObj(this_object$`scopes_supported`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`response_types_supported`)) {
        self$`response_types_supported` <- ApiClient$new()$deserializeObj(this_object$`response_types_supported`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`grant_types_supported`)) {
        self$`grant_types_supported` <- ApiClient$new()$deserializeObj(this_object$`grant_types_supported`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`subject_types_supported`)) {
        self$`subject_types_supported` <- ApiClient$new()$deserializeObj(this_object$`subject_types_supported`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`id_token_signing_alg_values_supported`)) {
        self$`id_token_signing_alg_values_supported` <- ApiClient$new()$deserializeObj(this_object$`id_token_signing_alg_values_supported`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`userinfo_signing_alg_values_supported`)) {
        self$`userinfo_signing_alg_values_supported` <- ApiClient$new()$deserializeObj(this_object$`userinfo_signing_alg_values_supported`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`request_object_signing_alg_values_supported`)) {
        self$`request_object_signing_alg_values_supported` <- ApiClient$new()$deserializeObj(this_object$`request_object_signing_alg_values_supported`, "array[character]", loadNamespace("synr"))
      }
      if (!is.null(this_object$`claims_supported`)) {
        self$`claims_supported` <- ApiClient$new()$deserializeObj(this_object$`claims_supported`, "array[character]", loadNamespace("synr"))
      }
      ...
      if (!is.null(this_object$`token_endpoint_auth_methods_supported`)) {
        self$`token_endpoint_auth_methods_supported` <- ApiClient$new()$deserializeObj(this_object$`token_endpoint_auth_methods_supported`, "array[character]", loadNamespace("synr"))
      }
      self
    },
    #' To JSON string
